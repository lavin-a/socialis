...
class Socialis:
    ...
    def connect_engine(self):
        conn1 = psycopg2.connect(host = credentials.host,
    ...
    def plot_bar(self, bar_n, m):
        ...
        df['named_ent'] = df['named_ent'].str.lower().apply(lambda x: ' '
                                                  .join([word for word in x.split() if word not in stop]))
        li = list()
    ...
    def plot_usernames(self):
        ...
        query = f"({settings.brand}) -{settings.brand}.com min_faves:100"
